...
//        restrictAccess();
    ...
    public void start(UserModel user){
       ...
       Home.setLayout(new GridBagLayout()); // agar isi panel di tengah otomatis
        ...
        JLabel homeLabel2 = new JLabel("Sistem Pendukung Keputusan Pemilihan Karyawan Terbaik");
        JLabel homeLabel3 = new JLabel("dengan Metode SAW pada Toko Sony Elektronik");
        ...
        Sidebar.setBackground(Color.decode("#666666"));
        ...
        Header.setBackground(Color.decode("#2b2a2a"));
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/images/sonny-200.png"))); // NOI18N
